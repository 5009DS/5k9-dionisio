...
// escolhe uma livre. 5176 é o padrão para execução manual — 5173 é do Forms,
// 5174 do Gestor e 5175 do Chronos, e o trocador de ferramenta conta com
// esses números em desenvolvimento (ver lib/ferramentas.js).
...
http.createServer((req, res) => {
    ...
    // Fallback de SPA: rota sem extensão (/roteiro/abc) não é arquivo —
...
}).listen(PORT, () => console.log(`5K9 Dionísio em http://localhost:${PORT}`));
